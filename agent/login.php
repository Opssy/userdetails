                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="../handlers/auth.php" autocomplete="on" method="post"> 
                                <h1>Log in</h1> 
                                <?php
                                ...
                                <p> 
                                    ...
                                    <input id="password" name="password" required="required" type="password" placeholder="eg. X8df!90" /> 
                                </p>
                                <p class="keeplogin"> 
                        ...
                        <div id="register" class="animate form">
                                ...
                                if (isset($_SESSION['error']) && $_SESSION['error'] !== "") {
                                    ?>
                                    <p style="padding:12px;"><?= $_SESSION['error']; ?></p>
